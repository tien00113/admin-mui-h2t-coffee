...
const SignIn: React.FC = () => {
  ...
  return (
    <div className='p-5'>
      {loginError && <ErrorLogin message={loginError} />}
      <div className="p-5 border-none dark:border-strokedark dark:bg-boxdark">
        <div className="flex justify-center items-center">
            <div className="xl:w-[40%] sm:w-[-50%] p-4 sm:p-5.5 xl:p-15.5 border shadow-default border-stroke">
              <h2 className="text-center mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2 items-center">
                Đăng Nhập Quản Trị
              </h2>
